                                        ...
                                        <div class="col-md-4">
                                            <div class="mt-3">
                                                ...
                                                <input type="text" class="form-control" name="ma_san_pham"
                                                    value="{{ $Product->ma_san_pham }}" readonly>
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="text" class="form-control" name="ten_san_pham"
                                                    ...
                                                    value="{{ $Product->ten_san_pham }}" id="ten_san_pham"
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control" name="gia"
                                                    id="gia" placeholder="Giá bán" @error('gia') is-invalid @enderror
                                                    value="{{ $Product->gia }}">
                                                @error('gia')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            ...
                                            <div class="row">
                                                <div class="mt-3">
                                                    ...
                                                    <input type="file" class="form-control" name="hinh_anh"
                                                        id="hinh_anh" @error('hinh_anh') is-invalid @enderror>
                                                    @error('hinh_anh')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <textarea class="form-control" name="mo_ta" id="mo_ta" rows="4">{{ $Product->mo_ta }}</textarea>
                                                </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="trang_thai" id="trang_thai_hien_thi"
                                                            ...
                                                            @if ($Product->trang_thai == 1) checked @endif
                                                    ...
                                                    <div>
                                                        <input type="radio" name="trang_thai"
                                                            ...
                                                            @error('trang_thai') is-invalid @enderror
                                                            @if ($Product->trang_thai == 0) checked @endif
                                                            value="{{ old('trang_thai') }}">
